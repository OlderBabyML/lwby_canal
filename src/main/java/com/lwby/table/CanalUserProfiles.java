...
public class CanalUserProfiles {
    ...
    public CanalUserProfiles(CanalEntry.EventType eventType, String tableName, List<CanalEntry.RowData> rowDataList) {
